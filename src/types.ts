...
export type Intent =
  ...
  | { type: 'add_people'; people: Array<{ name: string; department: string; crew: string; roles: string[] }> }
  | { type: 'update_people'; people: Array<{ name: string; full_name?: string; department?: string; crew?: string; roles?: string[] }> }
  ...
  | { type: 'get_report'; groups?: Array<{ filter_field: string; filter_value: string }>; show?: 'all' | 'completed' | 'missing' }
